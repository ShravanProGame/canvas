...
// 1. Setup Socket with CORS for about:blank
...
io.on('connection', (socket) => {
    ...
    // Other events (Typing, DMs, Admin, Owner)
    ...
    socket.on('switchChannel', (c) => {
        if (channelHistory[c]) socket.emit('loadHistory', channelHistory[c]);
    });
